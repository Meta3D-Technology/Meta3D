...
export let getWorkPluginContribute: getWorkPluginContributeMeta3D<state, config, states> = ({ mostService, webgpuService, engineCoreService, fsService, width, height }) => {
	return {
