...
export type service = {
    ...
    readonly createComponent: (_1: RegisterComponentType_usedComponentContribute) => [RegisterComponentType_usedComponentContribute, RegisterComponentType_component];
    ...
    readonly createGameObject: (_1: StateType_state) => [StateType_state, GameObjectType_gameObject];
    readonly getAllGameObjects: (_1: StateType_state) => GameObjectType_gameObject[];
