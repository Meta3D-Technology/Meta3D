...
// tslint:disable-next-line:interface-over-type-literal
export type componentContribute<state,config,dataName,component> = {
...
// tslint:disable-next-line:interface-over-type-literal
export type getComponentContribute<state,config,dataName,component> = () => componentContribute<state,config,dataName,component>;
