...
export let getTextData = (): languageTextData => {
    return {
        [language.Chinese]: {
            ...
            [model.EliteGiantessMagic1]: "精英巨大娘魔法1",
        ...
        [language.English]: {
            ...
            [languageKey.GenerateRate]: "Generate Rate",
            [languageKey.AddGenerateDataInAttackCityLevel]: "Add generate data in attack city level",
            [languageKey.AddGenerateDataInProtectCityLevel]: "Add generate data in protect city level",
            [languageKey.AddGenerateDataInBossLevel]: "Add generate data in boss level",
            ...
            [model.EliteGiantessMagic1]: "Elite Giantess Magic 1",
            [action.StompLight]: "Stomp Light",
            [action.StompHeavy]: "Stomp Heavy",
            ...
            [feature.PassiveBigger]: "Passive Bigger",
            ...
            [particleImage.Fireball1]: "Fireball 1",
