...
function create(usedComponentContribute, engineCoreService, width, height, widthSegments, heightSegments) {
  return CreateDefaultGeometryService$Meta3dComponentCommonlib.create(usedComponentContribute, engineCoreService, ComputePointsGeometryService$Meta3dComponentCommonlib.addTangents(_generate(width, height, widthSegments, heightSegments)));
}
