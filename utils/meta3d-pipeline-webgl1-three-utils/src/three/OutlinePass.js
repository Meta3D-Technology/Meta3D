...
export let setThreeAPI = (threeAPIObj) => {
	AdditiveBlending = threeAPIObj.AdditiveBlending
	...
	MeshDepthMaterial = threeAPIObj.MeshDepthMaterial
	NoBlending = threeAPIObj.NoBlending
	RGBADepthPacking = threeAPIObj.RGBADepthPacking
	ShaderMaterial = threeAPIObj.ShaderMaterial
	UniformsUtils = threeAPIObj.UniformsUtils
	Vector2 = threeAPIObj.Vector2
	Vector3 = threeAPIObj.Vector3
	WebGLRenderTarget = threeAPIObj.WebGLRenderTarget
