...
import { actionName, state, uiData } from "meta3d-action-mod-unit-set-generate-protocol"
import { eventName, inputData } from "meta3d-action-mod-unit-set-generate-protocol/src/EventType"
        ...
        init: (meta3dState) => {
            ...
            return new Promise((resolve, reject) => {
                resolve(eventSourcingService.on<inputData>(meta3dState, eventName, 0, (meta3dState, index: number) => {
                    ...
                    switch (index) {
                        case 0:
                            fieldName = "hasAttackCitySceneChapterGenerateData"
                            break
                        case 1:
                            fieldName = "hasProtectCitySceneChapterGenerateData"
                            break
                        case 2:
                            fieldName = "hasBossSceneChapterGenerateData"
                            break
                    }
