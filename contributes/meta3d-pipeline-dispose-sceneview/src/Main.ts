...
import { state, states, pipelineName, allPipelineData, job } from "meta3d-pipeline-dispose-sceneview-protocol/src/StateType";
import { config } from "meta3d-pipeline-dispose-sceneview-protocol/src/ConfigType";
