...
import { state, states, pipelineName, allPipelineData, job } from "meta3d-pipeline-editor-event-gameview-protocol/src/StateType";
import { config } from "meta3d-pipeline-editor-event-gameview-protocol/src/ConfigType";
