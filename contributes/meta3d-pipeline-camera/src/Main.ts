...
import { dependentExtensionProtocolNameMap, dependentContributeProtocolNameMap } from "meta3d-pipeline-camera-protocol/src/DependentMapType";
	...
	return {
		...
		createStateFunc: (meta3dState, { isDebug }) => {
			return {
				...
				engineSceneService: api.getExtensionService<engineSceneService>(meta3dState, meta3dEngineSceneExtensionProtocolName),
				isDebug
			}
		},
		initFunc: _init,
