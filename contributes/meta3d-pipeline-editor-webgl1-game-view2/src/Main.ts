...
import { config } from "meta3d-pipeline-editor-webgl1-game-view2-protocol/src/ConfigType";
import { state, states, pipelineName, allPipelineData, job } from "meta3d-pipeline-editor-webgl1-game-view2-protocol/src/StateType";
