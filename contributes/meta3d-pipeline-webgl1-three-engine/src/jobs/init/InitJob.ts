...
import { init, initForEngine } from "meta3d-pipeline-webgl1-three-utils/src/InitJobUtils"
import { state as meta3dState } from "meta3d-type"
import type { WebGLRenderer } from "three"
import { service as converterService } from "meta3d-scenegraph-converter-three-gameview-protocol/src/service/ServiceType"
...
export let execFunc: execFuncType = (meta3dState, { api, getStatesFunc, setStatesFunc }) => {
    ...
    return mostService.callFunc(() => {
        ...
        let data = initForEngine<converterService>(meta3dState, [converterService, threeAPIService, uiService], canvas,
        )
