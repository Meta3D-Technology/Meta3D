...
function computeTangents(vertices, texCoords, normals, indices) {
  ...
  while(i < vertexCount) {
    ...
    var ndott = Vector3$Meta3dCommonlib.dot(n, t1$1);
    var temp = Vector3$Meta3dCommonlib.scale(/* Float */0, n, ndott);
    var match$3 = Vector3$Meta3dCommonlib.normalize(Vector3$Meta3dCommonlib.sub(/* Float */0, t1$1, temp));
