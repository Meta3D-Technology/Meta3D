...
import { directionLight, config } from "meta3d-component-directionlight-protocol";

type state = any

export let getContribute: getComponentContributeMeta3D<state, config, directionLight>