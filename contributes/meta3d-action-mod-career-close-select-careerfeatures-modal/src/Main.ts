...
import { actionName, state, uiData } from "meta3d-action-mod-career-close-select-careerfeatures-modal-protocol"
import { eventName, inputData } from "meta3d-action-mod-career-close-select-careerfeatures-modal-protocol/src/EventType"
