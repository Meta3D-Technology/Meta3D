...
import { state, states, pipelineName, allPipelineData, job } from "meta3d-pipeline-transform-gameview-protocol/src/StateType";
import { config } from "meta3d-pipeline-transform-gameview-protocol/src/ConfigType";
	...
	return {
		...
		createStateFunc: (meta3dState, _) => {
			return {
				...
				engineCoreService: api.getExtensionService<engineCoreService>(meta3dState, "meta3d-engine-core-gameview-protocol")
			}
		},
		initFunc: _init,
