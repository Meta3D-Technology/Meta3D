...
import { eventName, eventData } from "meta3d-action-click-button-protocol"
...
export let getContribute: getContributeMeta3D<dependentExtensionNameMap, dependentContributeNameMap, actionContribute<eventData>> = (api, [dependentExtensionNameMap, _]) => {
