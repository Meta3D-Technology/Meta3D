...
import { actionName, state, uiData } from "meta3d-action-mod-career-load-careerpreview-protocol"
import { eventName, inputData, imageBase64 } from "meta3d-action-mod-career-load-careerpreview-protocol/src/EventType"
            ...
            return new Promise((resolve, reject) => {
                resolve(eventSourcingService.on<inputData>(meta3dState, eventName, 0, (meta3dState, imageBase64) => {
                    ...
                    meta3dState = api.action.setActionState(meta3dState, actionName, {
                        ...state,
                        preview: api.nullable.return(imageBase64)
                    })
