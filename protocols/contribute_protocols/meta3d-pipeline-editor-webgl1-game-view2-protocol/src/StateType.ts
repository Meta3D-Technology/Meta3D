...
export const pipelineName = "Editor_WebGL1_GameView2"
...
export enum job {
    Restore = "game_view2_gl_webgl1_restore_meta3d",
}
...
export const allPipelineData: allPipelineDataType = [
    {
        ...
        groups: [
            {
                name: "first_webgl1_game_view2_meta3d",
                link: "concat",
                elements: [
                    {
                        "name": job.Restore,
        ...
        first_group: "first_webgl1_game_view2_meta3d"
    }
]
