...
import type {filter as StateType_filter} from '../.././src/state/StateType.gen';

import type {format as StateType_format} from '../.././src/state/StateType.gen';

import type {htmlImageElement as Dom_htmlImageElement} from './Dom.gen';

import type {material as StateType_material} from '../.././src/state/StateType.gen';

import type {state as StateType_state} from '../.././src/state/StateType.gen';

import type {textureDataType as StateType_textureDataType} from '../.././src/state/StateType.gen';

import type {texture as StateType_texture} from '../.././src/state/StateType.gen';
...
export type service = {
  ...
  readonly getImage: (_1:StateType_state, _2:StateType_texture) => Dom_htmlImageElement; 
  readonly setImage: (_1:StateType_state, _2:StateType_texture, _3:Dom_htmlImageElement) => StateType_state
};
