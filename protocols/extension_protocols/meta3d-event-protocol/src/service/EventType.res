...
type keyboardEventData = {
  specialKeyMap: Meta3dCommonlibType.MutableSparseMapType.t<int, string>,
  shiftKeyByKeyCodeMap: Meta3dCommonlibType.MutableSparseMapType.t<int, string>,
  shiftKeyByCharCodeMap: Meta3dCommonlibType.MutableHashMapType.t<int, string>,
}
...
// external canvasToEventTarget: Meta3dWebgl.DomExtendType.htmlElement => Dom.eventTarget = "%identity"
