...
let publish = ([onUploadProgressFunc, uploadFileFunc, hasDataFunc, addDataFunc, updateDataFunc, getFileIDFunc], entryProtocolName, entryProtocolVersion, entryProtocolIconBase64, packageBinaryFile, packageName, packageVersion, account) => {
