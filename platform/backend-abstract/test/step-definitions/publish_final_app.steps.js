...
const PublishFinalAppService_1 = require("../../src/application_layer/publish/PublishFinalAppService");
const PublishFinalAppTool_1 = require("../tool/PublishFinalAppTool");
const feature = (0, jest_cucumber_1.loadFeature)("./test/features/publish_final_app.feature");
(0, jest_cucumber_1.defineFeature)(feature, test => {
    ...
    test('if not exist, publish should add finalApp', ({ given, and, when, then }) => {
        let contentBinaryFile, singleEventBinaryFile, finalAppName, account, description, previewBase64, isRecommend;
        let contentFileID = "1";
        let singleEventFileID = "2";
        _prepare(given);
        given('prepare funcs', () => {
            _createFuncsForPublish(sandbox);
            uploadFileFunc.onCall(0).returns((0, most_1.just)({ fileID: contentFileID }));
            uploadFileFunc.onCall(1).returns((0, most_1.just)({ fileID: singleEventFileID }));
        ...
        when('publish the finalApp', () => {
            return (0, PublishFinalAppService_1.publish)([onUploadProgressFunc, uploadFileFunc, deleteFileFunc, getDataByKeyFunc, addDataFunc, updateDataFunc, getFileIDFunc], contentBinaryFile, singleEventBinaryFile, finalAppName, account, description, previewBase64, 
            // useCount,
            isRecommend).drain();
        });
        ...
        and('add to collection', () => {
            expect(addDataFunc).toCalledWith([
                "publishedfinalapps",
                (0, PublishFinalAppTool_1.buildKey)(finalAppName, account),
                {
                    account,
                    finalAppName,
                    description,
    ...
    test('if exist, publish should overwrite finalApp', ({ given, and, when, then }) => {
        ...
        let contentBinaryFile1, singleEventBinaryFile1, finalAppName1, account1, description1, previewBase641, isRecommend1;
        let contentBinaryFile2, singleEventBinaryFile2, finalAppName2, account2, description2, previewBase642, isRecommend2;
        _prepare(given);
        given('prepare funcs', () => {
            _createFuncsForPublish(sandbox);
            uploadFileFunc.onCall(0).returns((0, most_1.just)({ fileID: contentFileID1 }));
            uploadFileFunc.onCall(1).returns((0, most_1.just)({ fileID: singleEventFileID1 }));
            uploadFileFunc.onCall(2).returns((0, most_1.just)({ fileID: contentFileID2 }));
            uploadFileFunc.onCall(3).returns((0, most_1.just)({ fileID: singleEventFileID2 }));
            getDataByKeyFunc.onCall(0).returns((0, PromiseTool_1.resolve)([]));
            getDataByKeyFunc.onCall(1).returns((0, PromiseTool_1.resolve)([{
        ...
        and('publish the first finalApp', () => {
            return (0, PublishFinalAppService_1.publish)([onUploadProgressFunc, uploadFileFunc, deleteFileFunc, getDataByKeyFunc, addDataFunc, updateDataFunc, getFileIDFunc], contentBinaryFile1, singleEventBinaryFile1, finalAppName1, account1, description1, previewBase641, 
            // useCount1,
            isRecommend1).drain();
        });
        when('publish the second finalApp', () => {
            return (0, PublishFinalAppService_1.publish)([onUploadProgressFunc, uploadFileFunc, deleteFileFunc, getDataByKeyFunc, addDataFunc, updateDataFunc, getFileIDFunc], contentBinaryFile2, singleEventBinaryFile2, finalAppName2, account2, description2, previewBase642, 
            // useCount2,
            isRecommend2).drain();
        });
        ...
        and('update collection', () => {
            ...
            expect(updateDataFunc).toCalledWith([
                "publishedfinalapps",
                (0, PublishFinalAppTool_1.buildKey)(finalAppName1, account1),
                {
                    account: account1,
...
//# sourceMappingURL=publish_final_app.steps.js.map