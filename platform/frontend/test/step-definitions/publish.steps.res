      ...
      () => {
        PublishTool.buildUI(
          ...
          ~service=ServiceTool.build(
            ~sandbox,
            ~useAllSelector=createEmptyStub(refJsObjToSandbox(sandbox.contents))->returns(
              (
                Some(""),
                (
                  (list{}, list{}, Obj.magic(1), true, list{}, true),
                  (CanvasControllerTool.buildCanvasData(), list{}, list{}, list{}, list{}),
                ),
