              ...
              ImportElementTool.buildElementAssembleData(
                ...
                ~uiControls=[
                  ImportElementTool.buildUIControl(
                    ...
                    ~displayName="e1",
                    ~rect=UIControlInspectorTool.buildRect(~x=1->CommonType.IntForRectField, ()),
                    ~isDraw=true->CommonType.BoolForIsDraw,
                    ~input=None,
                    ~event=[],
                    ~specific=[],
                ...
                ~customInputs=customInputs.contents->Meta3dCommonlib.ListSt.toArray,
                ~customActions=customActions.contents->Meta3dCommonlib.ListSt.toArray,
                (),
              ),
            ],
            (
