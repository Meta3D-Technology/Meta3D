...
let build = (
  ...
  ~useAllSelector=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~useSelector=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~useEffect=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ...
  react: {
    ...
    useAllSelector: useAllSelector->Obj.magic,
    useSelector: useSelector->Obj.magic,
    useEffect: useEffect->Obj.magic,
