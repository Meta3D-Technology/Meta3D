...
function SelectedContributesUtils(Props) {
                  ...
                  return React.createElement(Antd.List.Item, {
                              children: React.createElement(Antd.Card, {
                                    ...
                                    onClick: (function (param) {
                                        Curry._2(selectContribute, dispatch, id);
                                      }),
                                    bodyStyle: {
                                      padding: "0px"
                                    },
                                    ...
                                    children: React.createElement(Antd.Card.Meta, {
                                          title: React.createElement("span", {
                                              ...
                                              }, param[2].contributePackageData.displayName)
                                        })
                                  })
                            });
                })
...
var make = SelectedContributesUtils;
