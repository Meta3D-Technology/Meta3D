...
function PackagePackages(Props) {
  ...
  return React.createElement(PackagesUtils$Frontend.make, {
              ...
              selectedPackageNames: ListSt$Meta3dCommonlib.map(ReduxUtils$Frontend.PackageAssemble.useSelector(service.react.useSelector, useSelector), (function (param) {
                      return param.name;
                    })),
