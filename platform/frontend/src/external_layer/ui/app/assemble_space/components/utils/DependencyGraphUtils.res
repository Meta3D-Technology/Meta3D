...
type nodeData = {
  ...
  protocolIconBase64: ApAssembleStoreType.protocolIconBase64,
  displayName: option<string>,
  name: string,
  version: ApAssembleStoreType.version,
...
type nodeInData = {
  ...
  packageName: option<packageName>,
  protocol: Meta3d.ExtensionFileType.extensionProtocolData,
  protocolIconBase64: option<ApAssembleStoreType.protocolIconBase64>,
  title: string,
  name: option<string>,
  version: option<ApAssembleStoreType.version>,
}
...
module Method = {
  let _buildNodes = (
    service,
    (
      allPackagesNotStoredInApp: ApAssembleStoreType.selectedPackages,
      // allPackagesStoredInApp: ApAssembleStoreType.selectedPackages,
  ...
  let _checkDuplicateNode = (nodes: list<nodeData>) => {
    ...
    let arr =
      ...
      ->ListSt.filter(({protocol}) => {
        !ContributeTypeUtils.isInput(protocol.name)
      })
      ->ListSt.toArray
  ...
  let _convertSelectedDataFromForAppStoreToForApAssembleStore = (
    selectedPackagesForAppStore: list<AssembleSpaceCommonType.packageData>,
    ...
    (
      ...
      selectedExtensionsForAppStoreEdit->Meta3dCommonlib.ListSt.map(((
        (extension, protocolConfig): AssembleSpaceCommonType.extensionData,
        _,
      ...
      selectedContributesForAppStore->Meta3dCommonlib.ListSt.map((
        (contribute, protocolConfig): AssembleSpaceCommonType.contributeData,
  ...
  let _convertSelectedDataFromForApAssembleStoreToForPackageAssembleStore = (
    selectedPackagesForApAssembleStore: list<AssembleSpaceCommonType.packageData>,
    selectedExtensionsForAppStoreEdit,
    ...
    (
      ...
      )): PackageAssembleStoreType.extension => {
        {
          id: extension.id,
  ...
  let autoUpgradeVersion = (
    ...
    ->Meta3dCommonlib.ListSt.traverseReducePromiseM(list{}, (
      result,
      package: AssembleSpaceCommonType.packageData,
    ) => {
    ...
    ->Js.Promise.then_(selectedPackages => {
      ...
      ->Meta3dCommonlib.ListSt.traverseReducePromiseM(list{}, (
        result,
        extension: ApAssembleStoreType.extension,
      ) => {
    ...
    ->Js.Promise.then_(((selectedPackages, selectedExtensions)) => {
      ...
      ->Meta3dCommonlib.ListSt.traverseReducePromiseM(list{}, (
        result,
        contribute: ApAssembleStoreType.contribute,
      ) => {
