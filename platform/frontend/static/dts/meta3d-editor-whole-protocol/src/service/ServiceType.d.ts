...
type geometry$1 = geometry;
export type transform = number;
export type localToWorldMatrix = Float32Array;
type transform$1 = transform;
type parent$1 = transform$1;
...
type pbrMaterial$1 = pbrMaterial;
...
export type getGameObjectName = (meta3dState: state, gameObject: gameObject) => nullable<name$1>;
export type setGameObjectName = (meta3dState: state, gameObject: gameObject, name: name$1) => state;
...
export type getParent = (meta3dState: state, transform: transform$1) => nullable<parent$1>;
export type setParent = (meta3dState: state, transform: transform$1, parent: nullable<parent$1>) => state;
...
type getName$1 = (meta3dState: state, perspectiveCameraProjection: perspectiveCameraProjection) => nullable<string>;
type setName$1 = (meta3dState: state, perspectiveCameraProjection: perspectiveCameraProjection, name: string) => state;
...
type getName$2 = (meta3dState: state, pbrMaterial: pbrMaterial$1) => nullable<string>;
type setName$2 = (meta3dState: state, pbrMaterial: pbrMaterial$1, name: string) => state;
...
type getGameObjects$1 = (meta3dState: state, pbrMaterial: pbrMaterial$1) => Array<gameObject>;
...
type getName$3 = (meta3dState: state, texture: texture) => nullable<string>;
type setName$3 = (meta3dState: state, texture: texture, name: string) => state;
...
type getName$4 = (meta3dState: state, geometry: geometry$1) => nullable<string>;
type setName$4 = (meta3dState: state, geometry: geometry$1, name: string) => state;
...
type getGameObjects$2 = (meta3dState: state, geometry: geometry$1) => Array<gameObject>;
export type createBasicCameraView = (meta3dState: state) => [
	state,
	basicCameraView
];
type getGameObjects$3 = (meta3dState: state, basicCameraView: basicCameraView) => Array<gameObject>;
...
type getName$5 = (meta3dState: state, basicCameraView: basicCameraView) => nullable<string>;
type setName$5 = (meta3dState: state, basicCameraView: basicCameraView, name: string) => state;
export type createArcballCameraController = (meta3dState: state) => [
	state,
	arcballCameraController
];
type getGameObjects$4 = (meta3dState: state, arcballCameraController: arcballCameraController) => Array<gameObject>;
type getName$6 = (meta3dState: state, arcballCameraController: arcballCameraController) => nullable<string>;
type setName$6 = (meta3dState: state, arcballCameraController: arcballCameraController, name: string) => state;
...
type getName$7 = (meta3dState: state, directionLight: directionLight) => nullable<string>;
type setName$7 = (meta3dState: state, directionLight: directionLight, name: string) => state;
...
type getGameObjects$5 = (meta3dState: state, directionLight: directionLight) => Array<gameObject>;
export type createScript = (meta3dState: state) => [
	state,
	script
];
type getName$8 = (meta3dState: state, script: script) => nullable<string>;
type setName$8 = (meta3dState: state, script: script, name: string) => state;
...
type service$1 = {
	...
	//         getValueFunc<number>, setValueFunc<number>,
	//     ],
	gameObjectName: name$1, localPosition: localPosition, localEulerAngles: localEulerAngles, localScale: localScale, windowName: string, rect: rect$1) => [
		state,
		[
			nullable<name$1>,
...
type init$1 = (meta3dState: state) => Promise<state>;
type restore$1<state> = (currentState: state, targetState: state) => state;
type deepCopy$1<state> = (state: state) => state;
...
type handleFunc$1 = (customEvent: customEvent) => void;
...
type service$4 = {
	...
	onPointEvent(meta3dState: state, eventExtensionProtocolName: eventExtensionProtocolName, [pointEventName, priority, handleFunc]: [
		pointEventName,
		priority,
		handleFunc$1
	]): state;
	offPointEvent(meta3dState: state, eventExtensionProtocolName: eventExtensionProtocolName, [pointEventName, handleFunc]: [
		pointEventName,
		handleFunc$1
	]): state;
...
type restore$2<state> = (_1: state, _2: state) => state;
type deepCopy$2<state> = (_1: state) => state;
declare abstract class state$1 {
	protected opaque: any;
}
type gameObjectContribute$1 = gameObjectContribute<state$1>;
...
type pipelineData$1 = pipelineData;
type createStateFunc$1<config, state> = (meta3dState: state, config: config) => state;
// tslint:disable-next-line:interface-over-type-literal
...
type service$6 = {
	...
	readonly getGameObjectName: (_1: state, gameObject: gameObject) => nullable<name$1>;
	readonly setGameObjectName: (_1: state, gameObject: gameObject, name: name$1) => state;
...
type target$1 = "visual" | "visualRun";
...
type initFunc$1 = (meta3dState: state, initData: initDataForInitFunc) => Promise<state>;
