...
const feature = jest_cucumber_1.loadFeature("./test/features/get_all_publish_extensions.feature");
jest_cucumber_1.defineFeature(feature, test => {
    ...
    function _getAllPublishExtensions(protocolName, protocolVersion) {
        return ShopService_1._getAllPublishData([getDataFunc, getFileFunc], "publishedExtensions", protocolName, protocolVersion);
    }
    ...
    test('get all publish extension', ({ given, when, then, and }) => {
        ...
        given('prepare funcs', () => {
            ...
            getDataFunc.returns(PromiseTool_1.resolve({
                data: [
                    {
                        fileData: [
                            {
            ...
            getFileFunc.returns(most_1.just(file1));
        });
