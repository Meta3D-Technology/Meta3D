...
const feature = jest_cucumber_1.loadFeature("./test/features/get_all_publish_extension_protocols.feature");
jest_cucumber_1.defineFeature(feature, test => {
    ...
    function _getAllPublishExtensionProtocols() {
        return ShopService_1._getAllPublishProtocolData(getDataFunc, "publishedExtensionProtocols");
    }
