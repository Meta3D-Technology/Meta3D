...
let feature = loadFeature("./test/features/package/package_selectedExtensions.feature")
      ...
      useSelectorStub :=
        createEmptyStub(refJsObjToSandbox(sandbox.contents))->returns(
          list{
            ...
            PackageSelectedExtensionsTool.buildSelectedExtension(~name="e2", ~protocolIconBase64="i2", ()),
          },
          _,
        )
    })
