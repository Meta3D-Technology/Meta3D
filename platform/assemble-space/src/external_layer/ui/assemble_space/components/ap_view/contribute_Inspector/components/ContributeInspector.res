...
module Method = {
  ...
  let setContributeNewName = (
    dispatch,
    inspectorCurrentContribute: FrontendUtils.ApViewStoreType.contribute,
    newName: string,
  ) => {
    dispatch(
      FrontendUtils.ApViewStoreType.SetContributeNewName(
  ...
  let useSelector = (
    {inspectorCurrentContributeId, selectedContributes}: FrontendUtils.ApViewStoreType.state,
  ) => {
