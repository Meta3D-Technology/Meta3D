...
import type {addComponentFunc as IComponentForJs_addComponentFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {componentName as IComponentForJs_componentName} from '../../src/scene_graph/IComponentForJs.gen';

import type {createComponentFunc as IComponentForJs_createComponentFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {getAllComponentsFunc as IComponentForJs_getAllComponentsFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {getComponentDataFunc as IComponentForJs_getComponentDataFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {getComponentFunc as IComponentForJs_getComponentFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {getGameObjectsFunc as IComponentForJs_getGameObjectsFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {hasComponentFunc as IComponentForJs_hasComponentFunc} from '../../src/scene_graph/IComponentForJs.gen';

import type {setComponentDataFunc as IComponentForJs_setComponentDataFunc} from '../../src/scene_graph/IComponentForJs.gen';
