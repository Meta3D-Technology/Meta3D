        ...
        test("convert allExtensionFileData and allContributeFileData", (function (param) {
                ...
                Curry._2(given, "generate two extensions that the seond is started", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              ...
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension", {
                                      protocolName: "second-extension-protocol",
                                      protocolVersion: ">=0.4.1 < 1.0.0"
                                    })), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute", {
                        ...
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              ...
                              version: "^0.5.2"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-package-entry-extension", {
                ...
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              ...
                              version: "^0.5.3"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyContributeFileStr(undefined), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
                ...
                Curry._2(param.then, "converted package data is correct", (function (param) {
                        ...
                        Operators$Meta3dBsJestCucumber.$eq(expect([
                              ...
                              [
                                {
                                  ...
                                  dependentExtensionProtocolNameMap: ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension", {
                                        protocolName: "second-extension-protocol",
                                        protocolVersion: ">=0.4.1 < 1.0.0"
                                      }),
                                  dependentContributeProtocolNameMap: ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute", {
                                        protocolName: "first-contribute-protocol",
                                        protocolVersion: "^0.5.2"
                                      })
                                },
                                {
                                  ...
                                  dependentExtensionProtocolNameMap: ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-package-entry-extension", {
                                        protocolName: "first-package-entry-extension-protocol",
                                        protocolVersion: ">=0.4.1 < 1.0.0"
                                      }),
                                  dependentContributeProtocolNameMap: ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute", {
                              ...
                              [{
                                  ...
                                  dependentExtensionProtocolNameMap: ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined),
                                  dependentContributeProtocolNameMap: ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)
                                }]
                            ]);
                      }));
              }));
        test("load and start generated app", (function (param) {
                ...
                Curry._2(given, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "package-first-extension", {
                        ...
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "^0.5.2"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute", {
                                      protocolName: "first-contribute-protocol",
                                      protocolVersion: "^0.5.2"
                                    })), undefined);
                      }));
                ...
                Curry._2(and, "generate one package as p1 with one extension and one contribute", (function (param) {
                        var extension = ExtensionFileManagerTool$Meta3d.generateExtension("package-first-extension", {
                              ...
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStr(undefined), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
        ...
        test("if two extension need start, error", (function (param) {
                ...
                Curry._2(and, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "^0.5.2"
                            }, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
        ...
        var _prepareForLoadAndHandleGeneratedApp = function (given, and, param) {
          ...
          Curry._2(given, "generate two extensions", (function (param) {
                  firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                        name: "first-extension-protocol",
                        version: "^0.4.1"
                      }, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandle, 1), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                  secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                        name: "second-extension-protocol",
                        version: "^0.5.2"
                      }, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandle, 2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                }));
