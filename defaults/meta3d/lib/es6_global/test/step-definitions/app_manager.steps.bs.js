...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("load and start generated app", (function (param) {
                ...
                return Curry._2(and, "the second extension should be started", (function (param) {
                              return Operators$Meta3dBsJestCucumber.$eq(expect(AppManagerTool$Meta3d.getStartFlag(undefined)), 2);
                            }));
              }));
        var _prepareForLoadAndHandleGeneratedApp = function (given, and, param) {
          ...
          Curry._2(given, "prepare flag", (function (param) {
                  return Curry._1(prepareFlag, undefined);
                }));
          Curry._2(given, "generate two extensions", (function (param) {
                  firstExtension.contents = Main$Meta3d.generateExtension({
                        name: "first-extension",
        ...
        test("load and init generated app", (function (param) {
                ...
                return Curry._2(param.then, "the first extension should be inited", (function (param) {
                              return Operators$Meta3dBsJestCucumber.$eq(expect(AppManagerTool$Meta3d.getInitFlag(undefined)), 11);
                            }));
              }));
        test("load and update generated app", (function (param) {
                ...
                return Curry._2(param.then, "the second extension should be updated", (function (param) {
                              return Operators$Meta3dBsJestCucumber.$eq(expect(AppManagerTool$Meta3d.getUpdateFlag(undefined)), 22);
                            }));
              }));
