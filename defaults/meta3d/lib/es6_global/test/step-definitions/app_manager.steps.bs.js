...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("convert allExtensionFileData and allContributeFileData", (function (param) {
                ...
                Curry._2(given, "generate two extensions that the seond is started", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              ...
                              version: "^0.4.1"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              ...
                              version: "^0.5.2"
                            }, "0.0.2", "meta3d", "s2", "r2", "d2", AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-package-entry-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
        ...
        test("load and start generated app", (function (param) {
                ...
                Curry._2(given, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "package-first-extension-protocol", ">=0.4.1 < 1.0.0"), "second-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "^0.5.2"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute-protocol", "^0.5.2")), undefined);
                      }));
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              name: "first-contribute-protocol",
                ...
                Curry._2(and, "generate one package as p1 with one extension and one contribute", (function (param) {
                        var extension = ExtensionFileManagerTool$Meta3d.generateExtension("package-first-extension", {
                              ...
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStr(undefined), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
        ...
        test("if two extension need start, error", (function (param) {
                ...
                Curry._2(and, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "^0.5.2"
        ...
        var _prepareForLoadAndHandleGeneratedApp = function (given, and, param) {
          ...
          Curry._2(given, "generate two extensions", (function (param) {
                  firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                        name: "first-extension-protocol",
                        version: "^0.4.1"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandle, 1), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                  secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                        name: "second-extension-protocol",
                        version: "^0.5.2"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandle, 2), undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                }));
        ...
        test("load generated app with package store in app", (function (param) {
                ...
                Curry._2(param.when, "generate app with p1 and load it", (function (param) {
                        var match = Main$Meta3d.loadApp(Main$Meta3d.generateApp([
                                  [],
                                  []
                                ], [], [[
                                    AppManagerTool$Meta3d.buildPackageData(p1ProtocolName, undefined, undefined, undefined, undefined, undefined, undefined),
                                    p1.contents
                                  ]], null));
        ...
        test("get all pacakge and extension and contribute file data of app", (function (param) {
                var and = param.and;
                var given = param.given;
                var p1 = {
                  contents: 1
                ...
                Curry._2(and, "generate one extension as e1", (function (param) {
                        e1.contents = ExtensionFileManagerTool$Meta3d.generateExtension(e1Name, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined);
                      }));
                ...
                Curry._2(and, "load e1, c1 and convert as l1", (function (param) {
                        l1.contents = Main$Meta3d.convertAllFileDataForApp([Main$Meta3d.loadExtension(e1.contents)], [Main$Meta3d.loadContribute(c1.contents)], []);
                      }));
                Curry._2(and, "generate app with p1, l1 as a1", (function (param) {
                        a1.contents = Main$Meta3d.generateApp(l1.contents, [], [[
                                AppManagerTool$Meta3d.buildPackageData(p1ProtocolName, undefined, undefined, undefined, undefined, undefined, undefined),
                                p1.contents
                              ]], null);
                      }));
                Curry._2(param.when, "get all pacakge and extension and contribute file data of a1", (function (param) {
                        result.contents = Main$Meta3d.getAllPackageAndExtensionAndContributeFileDataOfApp(a1.contents);
                      }));
                Curry._2(param.then, "should return parsed p1, parsed e1, parsed c1", (function (param) {
                        ...
                        if (match$1.length === 1) {
                          ...
                          if (match$3.length === 1) {
                            var parsedE1 = match$3[0];
                            var match$4 = match$2[1];
                            if (match$4.length === 1) {
                              var parsedC1 = match$4[0];
