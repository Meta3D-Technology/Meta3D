...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("convert allExtensionFileData and allContributeFileData", (function (param) {
                ...
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              ...
                              version: "^0.5.3"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyContributeFileStr(undefined), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
        ...
        test("load and start generated app", (function (param) {
                ...
                Curry._2(given, "generate two extensions", (function (param) {
                        ...
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "^0.5.2"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute-protocol", "^0.5.2")), undefined);
                      }));
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              name: "first-contribute-protocol",
                              version: "^0.5.3"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyContributeFileStr(undefined), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
                Curry._2(and, "generate one package as p1 with one extension and one contribute", (function (param) {
                        var extension = ExtensionFileManagerTool$Meta3d.generateExtension("package-first-extension", {
                              ...
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStr(undefined), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
        ...
        test("if two extension need start, error", (function (param) {
                ...
                Curry._2(and, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "^0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(1), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "^0.5.2"
                            }, undefined, undefined, undefined, undefined, undefined, AppManagerTool$Meta3d.buildEmptyExtensionFileStrWithOnStart(2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
        ...
        var _prepareForLoadAndHandleGeneratedApp = function (given, and, param) {
          ...
          Curry._2(given, "generate two extensions", (function (param) {
                  firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                        name: "first-extension-protocol",
                        version: "^0.4.1"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandle, 1), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                  secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                        name: "second-extension-protocol",
                        version: "^0.5.2"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandle, 2), Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                }));
        ...
        test("load generated app with package store in app", (function (param) {
                ...
                CucumberAsync$Meta3dBsJestCucumber.execStep(param.when, "generate app with p1 and load it", (function (param) {
