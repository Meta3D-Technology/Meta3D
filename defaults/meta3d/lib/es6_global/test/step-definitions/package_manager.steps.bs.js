...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("convert allExtensionFileData and allContributeFileData", (function (param) {
                ...
                Curry._2(given, "generate two extensions that the seond is entry", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              ...
                              version: "0.4.1"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              ...
                              version: "0.5.2"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute-protocol", "^0.6.2")), undefined);
                ...
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              ...
                              version: "0.5.3"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
        ...
        test("load generated package", (function (param) {
                ...
                Curry._2(given, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "0.5.2"
                            }, undefined, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute-protocol", "^0.5.2")), undefined);
                      }));
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              name: "first-contribute-protocol",
                ...
                Curry._2(param.when, "generate package with c1 and load it", (function (param) {
                        var match = Main$Meta3d.loadPackage(Main$Meta3d.generatePackage(c1.contents, [], AppManagerTool$Meta3d.buildPackageData(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)));
        ...
        test("load generated package which contains other packages", (function (param) {
                ...
                Curry._2(and, "generate package p1 with c1", (function (param) {
                        p1.contents = Main$Meta3d.generatePackage(c1.contents, [], AppManagerTool$Meta3d.buildPackageData(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined));
                      }));
                Curry._2(and, "generate two extensions", (function (param) {
                        e2.contents = ExtensionFileManagerTool$Meta3d.generateExtension("e2", {
                              name: "e2-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "e3-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                ...
                Curry._2(param.when, "generate package p2 with c2, p1 and load it", (function (param) {
                        var match = Main$Meta3d.loadPackage(Main$Meta3d.generatePackage(c2.contents, [p1.contents], AppManagerTool$Meta3d.buildPackageData(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)));
                        entryExtensionProtocolName.contents = match[2];
                        state.contents = match[0];
                      }));
        ...
        var _prepareForLoadAndHandleGeneratedPackage = function (given, and, param) {
          ...
          Curry._2(given, "generate two extensions", (function (param) {
                  firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                        name: "first-extension-protocol",
                        version: "0.4.1"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandleForExtension1, undefined), undefined, undefined, undefined);
                  secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                        name: "second-extension-protocol",
                        version: "0.5.2"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandleForExtension2, undefined), undefined, undefined, undefined);
                }));
          Curry._2(and, "mark the second extension as entry", (function (param) {
                  entryExtensionName.contents = "second-extension";
                }));
        ...
        test("get all data of package", (function (param) {
                var and = param.and;
                var given = param.given;
                var e1 = {
                  contents: 1
                };
                var e1FileStr = PackageManagerTool$Meta3d.buildEmptyExtensionFileStr(undefined);
                var e2 = {
                  contents: 1
                };
                var e2FileStr = PackageManagerTool$Meta3d.buildEmptyExtensionFileStr(undefined);
                var ct1 = {
                  contents: 1
                };
                var ct1FileStr = PackageManagerTool$Meta3d.buildEmptyContributeFileStr(undefined);
                var c1 = {
                  contents: 1
                };
                var c2 = {
                ...
                Curry._2(given, "generate one extension as e1", (function (param) {
                        e1.contents = ExtensionFileManagerTool$Meta3d.generateExtension("e1", {
                              name: "e1-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, e1FileStr, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
                Curry._2(and, "generate one contribute as ct1", (function (param) {
                        ct1.contents = ExtensionFileManagerTool$Meta3d.generateContribute("ct1", {
                              name: "ct1-protocol",
                              version: "0.5.3"
                            }, undefined, undefined, undefined, undefined, undefined, ct1FileStr, undefined, undefined, undefined);
                      }));
                Curry._2(and, "mark e1 as entry", (function (param) {
                        entryExtensions.contents = ["e1"];
                      }));
                Curry._2(and, "load them and convert as c1", (function (param) {
                        var e1FileData = Main$Meta3d.loadExtension(e1.contents);
                        var ct1FileData = Main$Meta3d.loadContribute(ct1.contents);
                        c1.contents = Main$Meta3d.convertAllFileDataForPackage([e1FileData], [ct1FileData], entryExtensions.contents);
                      }));
                Curry._2(given, "generate one extension as e2", (function (param) {
                        e2.contents = ExtensionFileManagerTool$Meta3d.generateExtension("e2", {
                              name: "e2-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, e2FileStr, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
                Curry._2(and, "mark e2 as entry", (function (param) {
                        entryExtensions.contents = ["e2"];
                      }));
                Curry._2(and, "load it and convert as c2", (function (param) {
                        var e2FileData = Main$Meta3d.loadExtension(e2.contents);
                        c2.contents = Main$Meta3d.convertAllFileDataForPackage([e2FileData], [], entryExtensions.contents);
                      }));
                Curry._2(and, "generate package p1 with c2", (function (param) {
                        p1.contents = Main$Meta3d.generatePackage(c2.contents, [], AppManagerTool$Meta3d.buildPackageData(undefined, undefined, undefined, undefined, undefined, undefined, "p1", undefined));
                      }));
                Curry._2(and, "generate package p2 with c1, p1 and pacakge data as d1", (function (param) {
                        p2.contents = Main$Meta3d.generatePackage(c1.contents, [p1.contents], AppManagerTool$Meta3d.buildPackageData(undefined, undefined, undefined, undefined, undefined, undefined, "p2", undefined));
                      }));
                Curry._2(param.when, "get all data of p2", (function (param) {
                        result.contents = Main$Meta3d.getAllDataOfPackage(p2.contents);
                      }));
                Curry._2(param.then, "should return e1, ct1, p1, d1 whose func data is binary file", (function (param) {
                        var match = result.contents;
                        Operators$Meta3dBsJestCucumber.$eq(expect([
                                  Main$Meta3d.getExtensionFuncDataStr(Tuple2$Meta3dCommonlib.getLast(Caml_array.get(match[0], 0))),
                                  Main$Meta3d.getContributeFuncDataStr(Tuple2$Meta3dCommonlib.getLast(Caml_array.get(match[1], 0))),
                                  match[2],
                                  match[3]
                                ]), [
                              e1FileStr,
                              ct1FileStr,
                              [p1.contents],
                              AppManagerTool$Meta3d.buildPackageData(undefined, undefined, undefined, undefined, undefined, undefined, "p2", undefined)
                            ]);
                      }));
              }));
      }));
