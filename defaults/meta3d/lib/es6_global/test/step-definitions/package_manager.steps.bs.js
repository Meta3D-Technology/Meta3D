...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("get all extension and contribute file data of package", (function (param) {
                var and = param.and;
                var given = param.given;
                var firstExtension = {
                  contents: 1
                };
                var firstExtensionFileStr = PackageManagerTool$Meta3d.buildEmptyExtensionFileStr(undefined);
                var firstContribute = {
                  contents: 1
                };
                var firstContributeFileStr = PackageManagerTool$Meta3d.buildEmptyContributeFileStr(undefined);
                var c1 = {
                  contents: 1
                };
                var entryExtensions = {
                ...
                Curry._2(given, "generate one extension", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, firstExtensionFileStr, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              name: "first-contribute-protocol",
                              version: "0.5.3"
                            }, undefined, undefined, undefined, undefined, undefined, firstContributeFileStr, undefined, undefined, undefined);
                      }));
                Curry._2(and, "mark the extension as entry", (function (param) {
                        entryExtensions.contents = ["first-extension"];
                      }));
                Curry._2(and, "load them and convert as c1", (function (param) {
                        var firstExtensionFileData = Main$Meta3d.loadExtension(firstExtension.contents);
                        var firstContributeFileData = Main$Meta3d.loadContribute(firstContribute.contents);
                        c1.contents = Main$Meta3d.convertAllFileDataForPackage([firstExtensionFileData], [firstContributeFileData], entryExtensions.contents);
                      }));
                Curry._2(and, "generate package with c1", (function (param) {
                        pacakge.contents = Main$Meta3d.generatePackage(c1.contents, []);
                      }));
                Curry._2(param.when, "get all extension and contribute file data of the package", (function (param) {
                        result.contents = Main$Meta3d.getAllExtensionAndContributeFileDataOfPackage(pacakge.contents);
                      }));
                Curry._2(param.then, "should return the extension and the contribute whose func data is binary file", (function (param) {
                        ...
                        Operators$Meta3dBsJestCucumber.$eq(expect([
                              ...
                              firstExtensionFileStr,
                              firstContributeFileStr
                            ]);
                      }));
              }));
      }));
