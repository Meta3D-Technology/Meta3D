        ...
        test("convert allExtensionFileData and allContributeFileData", (function (param) {
                ...
                Curry._2(given, "generate two extensions that the seond is entry", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              ...
                              version: "0.4.1"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              ...
                              version: "0.5.2"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute-protocol", "^0.6.2")), undefined);
                ...
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              ...
                              version: "0.5.3"
                            }, "0.0.1", "meta3d", undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
        ...
        test("load generated package", (function (param) {
                ...
                Curry._2(given, "generate two extensions", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "second-extension-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
                        secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                              name: "second-extension-protocol",
                              version: "0.5.2"
                            }, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "first-contribute-protocol", "^0.5.2")), undefined);
                      }));
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              name: "first-contribute-protocol",
        ...
        test("load generated package which contains other packages", (function (param) {
                ...
                Curry._2(and, "generate two extensions", (function (param) {
                        e2.contents = ExtensionFileManagerTool$Meta3d.generateExtension("e2", {
                              name: "e2-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, undefined, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.set(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined), "e3-protocol", ">=0.4.1 < 1.0.0"), "first-contribute-protocol", "^0.5.2")), undefined);
        ...
        var _prepareForLoadAndHandleGeneratedPackage = function (given, and, param) {
          ...
          Curry._2(given, "generate two extensions", (function (param) {
                  firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                        name: "first-extension-protocol",
                        version: "0.4.1"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandleForExtension1, undefined), undefined, undefined);
                  secondExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("second-extension", {
                        name: "second-extension-protocol",
                        version: "0.5.2"
                      }, undefined, undefined, undefined, undefined, undefined, Curry._1(buildEmptyExtensionFileStrWithLifeHandleForExtension2, undefined), undefined, undefined);
                }));
          Curry._2(and, "mark the second extension as entry", (function (param) {
                  entryExtensionName.contents = "second-extension";
                }));
        ...
        test("get all extension and contribute file data of package", (function (param) {
                ...
                Curry._2(given, "generate one extension", (function (param) {
                        firstExtension.contents = ExtensionFileManagerTool$Meta3d.generateExtension("first-extension", {
                              name: "first-extension-protocol",
                              version: "0.4.1"
                            }, undefined, undefined, undefined, undefined, undefined, firstExtensionFileStr, Caml_option.some(ImmutableHashMap$Meta3dCommonlib.createEmpty(undefined, undefined)), undefined);
                      }));
                Curry._2(and, "generate one contribute", (function (param) {
                        firstContribute.contents = ExtensionFileManagerTool$Meta3d.generateContribute("first-contribute", {
                              name: "first-contribute-protocol",
                              version: "0.5.3"
                            }, undefined, undefined, undefined, undefined, undefined, firstContributeFileStr, undefined, undefined);
                      }));
