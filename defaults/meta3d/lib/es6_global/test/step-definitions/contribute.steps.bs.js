...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("get all contributes by type", (function (param) {
                ...
                Curry._2(param.given, "register action, component, element, ui control, skin, gameObject, pipeline contributes", (function (param) {
                        ...
                        state.contents = Main$Meta3d.registerContribute(state.contents, "s1", (function (param, param$1) {
                        ...
                        state.contents = Main$Meta3d.registerContribute(state.contents, "w1", (function (param, param$1) {
                                return ContributeTool$Meta3d.buildGetContributeFunc(partial_arg$6, param, param$1);
                              }), _buildEmptyMapData(undefined));
                      }));
        ...
        test("register contribute with unknown type", (function (param) {
                ...
                Curry._2(param.and, "get all contributes by action type by api", (function (param) {
                        
                      }));
                Curry._2(param.then, "get empty", (function (param) {
                        Operators$Meta3dBsJestCucumber.$eq(expect(JSON.stringify(APITool$Meta3d.buildAPI(undefined).getAllContributesByType(state.contents, /* Action */3))), "[]");
                      }));
              }));
        test("register contribute which already registered before", (function (param) {
                var state = {
                  contents: 1
                };
                var protocolName = "p1";
                Curry._2(param.given, "register contribute of protocol name p1", (function (param) {
                        state.contents = StateTool$Meta3d.create(undefined);
                        state.contents = Main$Meta3d.registerContribute(state.contents, protocolName, (function (param, param$1) {
                                return ContributeTool$Meta3d.buildGetContributeFunc(1, param, param$1);
                              }), _buildEmptyMapData(undefined));
                      }));
