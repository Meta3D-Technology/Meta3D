...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        return test("register contribute with unknown type", (function (param) {
                      var state = {
                        contents: 1
                      };
                      ...
                      return Curry._2(param.then, "get empty", (function (param) {
                                    return Operators$Meta3dBsJestCucumber.$eq(expect(JSON.stringify(APITool$Meta3d.buildAPI(undefined).getAllContributesByType(state.contents, /* Action */3))), "[]");
                                  }));
                    }));
      }));
