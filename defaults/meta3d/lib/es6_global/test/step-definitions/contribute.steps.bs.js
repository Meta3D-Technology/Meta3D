...
JestCucumber.defineFeature(feature, (function (test) {
        test("get all contributes by type", (function (param) {
                ...
                Curry._2(param.given, "register action, component, element, ui control, skin, gameObject, pipeline contributes", (function (param) {
                        ...
                        state.contents = Main$Meta3d.registerContribute(state.contents, "w1", (function (param) {
                                return ContributeTool$Meta3d.buildGetContributeFunc(partial_arg$7, param);
                              }));
                      }));
        ...
        test("register contribute which is not action and already registered before", (function (param) {
                var state = {
                  contents: 1
                };
                var protocolName = "p1";
        ...
        test("register contribute which is action and already registered before", (function (param) {
                var state = {
                  contents: 1
                };
                var protocolName = "p1";
                Curry._2(param.given, "register action a1 of protocol name p1", (function (param) {
                        state.contents = StateTool$Meta3d.create(undefined);
                        var partial_arg = {
                          actionName: "a1",
                          handler: 1
                ...
                Curry._2(param.when, "register action a2 of protocol name p1", (function (param) {
