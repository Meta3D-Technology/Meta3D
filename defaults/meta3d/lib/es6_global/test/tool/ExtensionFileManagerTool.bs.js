...
function generateExtension(name, protocol, versionOpt, accountOpt, displayNameOpt, repoLinkOpt, descriptionOpt, fileStrOpt, dependentBlockProtocolNameMapOpt, param) {
...
function generateContribute(name, protocol, versionOpt, accountOpt, displayNameOpt, repoLinkOpt, descriptionOpt, fileStrOpt, dependentBlockProtocolNameMapOpt, param) {
  var version = versionOpt !== undefined ? versionOpt : "0.0.1";
  var account = accountOpt !== undefined ? accountOpt : "meta3d";
  var displayName = displayNameOpt !== undefined ? displayNameOpt : "";
  var repoLink = repoLinkOpt !== undefined ? repoLinkOpt : "";
