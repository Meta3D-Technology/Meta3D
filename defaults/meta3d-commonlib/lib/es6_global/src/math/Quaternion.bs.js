...
function setFromEulerAngles(param) {
  var halfToRad = 0.5 * Angle$Meta3dCommonlib.getDegToRad(undefined);
...
function getEulerAngles(quat) {
  ...
  return Vector3$Meta3dCommonlib.scale(/* Float */0, _getEulerAngles(quat), rad_to_deg);
}

function setFromAxisAngle(angle, axis) {
  var match = Vector3$Meta3dCommonlib.normalize(axis);
  var angle$1 = angle * 0.5 * Angle$Meta3dCommonlib.getDegToRad(undefined);
