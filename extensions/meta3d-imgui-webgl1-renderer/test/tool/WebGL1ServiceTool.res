...
let buildService = (
  ...
  ~getColorBufferBit=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~getDepthBufferBit=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~getStencilBufferBit=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
