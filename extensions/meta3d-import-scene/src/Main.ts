...
let _activeFirstBasicCameraViewAndAddArcballCameraController = (api: api, meta3dState: meta3dState): meta3dState => {
    let { scene } = api.getExtensionService<editorEngineWholeService>(meta3dState, "meta3d-editor-engine-whole-protocol")
    ...
    return {
        import: (meta3dState, sceneGLB) => {
            ...
            return new Promise((resolve, reject) => {
                ...
                meta3dState = _activeFirstBasicCameraViewAndAddArcballCameraController(api, meta3dState)
