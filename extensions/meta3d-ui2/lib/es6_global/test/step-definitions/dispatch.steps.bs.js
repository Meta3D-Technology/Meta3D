...
import * as ReducerTool$Meta3dUi2 from "../tool/ReducerTool.bs.js";
...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("if element state change, update data", (function (param) {
                ...
                Curry._2(given, "register element1 with reducer1 and elementState1 whose data1 = 1", (function (param) {
                        ...
                        state.contents = MainTool$Meta3dUi2.registerElement(sandbox, state.contents, 1, elementName1, undefined, Caml_option.some(elementState1.contents), Caml_option.some(NullableSt$Meta3dCommonlib.$$return(ReducerTool$Meta3dUi2.buildReducers("role1", [{
                                            actionName: "action1",
                ...
                Curry._2(param.when, /^dispatch action to set data(\d+) to (\d+)$/, (function (param) {
                        ...
                        state.contents = MainTool$Meta3dUi2.dispatch(state.contents, "action1", "role1", (function (v) {
                                return 10;
                              }));
                        
                      }));
                Curry._2(param.then, "mark state change", (function (param) {
                        return Operators$Meta3dBsJestCucumber.$eq(expect(MainTool$Meta3dUi2.isStateChange(state.contents, elementName1)), true);
                      }));
                return Curry._2(and, /^data(\d+) should be (\d+)$/, (function (param) {
                              ...
                              return Operators$Meta3dBsJestCucumber.$eq(expect(MainTool$Meta3dUi2.getElementState(state.contents, elementName1).data1), Caml_array.get($$arguments, 1));
                            }));
              }));
        return test("else, not update data", (function (param) {
                      ...
                      Curry._2(param.then, "mark state not change", (function (param) {
                              return Operators$Meta3dBsJestCucumber.$eq(expect(MainTool$Meta3dUi2.isStateChange(state.contents, elementName1)), false);
                            }));
                      return Curry._2(and, "data1 should not change", (function (param) {
                                    return Operators$Meta3dBsJestCucumber.$eq(expect(MainTool$Meta3dUi2.getElementState(state.contents, elementName1).data1), 10);
                                  }));
                    }));
      }));
