...
JestCucumber.defineFeature(feature, (function (test) {
        return test("register skin", (function (param) {
                      ...
                      return Curry._2(param.then, "get skin should return it", (function (param) {
                                    return Operators$Meta3dBsJestCucumber.$eq(expect(MainTool$Meta3dUi.getSkin(state.contents, skinName)), NullableSt$Meta3dCommonlib.$$return(MainTool$Meta3dUi.buildSkinContribute(skinName, 5)));
                                  }));
                    }));
      }));
