...
JestCucumber.defineFeature(feature, (function (test) {
        ...
        test("get context", (function (param) {
                ...
                Curry._2(and, "prepare imgui renderer service", (function (param) {
                        ...
                        imguiRendererService.contents = ImguiRendererServiceTool$Meta3dUi.buildService(sandbox, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, getContextStub.contents, undefined, undefined, undefined);
                      }));
                ...
                Curry._2(param.when, "get context", (function (param) {
                        result.contents = MainTool$Meta3dUi.getContext(sandbox, getExtensionServiceStub.contents, undefined, undefined, undefined, imguiRendererExtensionProtocolName, 22, undefined);
                      }));
