...
> = (api) => {
	return {
		init: (meta3dState: meta3dState) => {
			...
			return init(api, meta3dState, "meta3d-bs-most-protocol", "meta3d-engine-core-sceneview-protocol")
		},
		update: (meta3dState: meta3dState) => {
			return update(api, meta3dState, "meta3d-bs-most-protocol", "meta3d-engine-core-sceneview-protocol")
		},
		render: (meta3dState: meta3dState) => {
			return render(api, meta3dState, "meta3d-bs-most-protocol", "meta3d-engine-core-sceneview-protocol")
		},
