...
import { dependentExtensionProtocolNameMap, dependentContributeProtocolNameMap } from "meta3d-editor-protocol/src/service/DependentMapType"
...
export let getExtensionService: getExtensionServiceMeta3D<
	...
	service
> = (api, [{ meta3dTest1ExtensionProtocolName }, _dependentContributeProtocolNameMap]) => {
	return {
		run: (meta3dState) => {
			let test1State = api.getExtensionState<test1State>(meta3dState, meta3dTest1ExtensionProtocolName)


			let { log, registerInfo } = api.getExtensionService<test1Service>(meta3dState, meta3dTest1ExtensionProtocolName)
			...
			meta3dState = api.setExtensionState(meta3dState, meta3dTest1ExtensionProtocolName, test1State)
