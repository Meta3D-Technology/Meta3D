...
@bs.module("most")
external drain: Meta3dBsMostProtocol.StreamType.stream<'a> => Js.Promise.t<unit> = ""
...
@bs.module("most") external empty: unit => Meta3dBsMostProtocol.StreamType.stream<unit> = ""

/* Creates a Meta3dBsMostProtocol.StreamType.stream containing only x */
@bs.module("most") external just: 'a => Meta3dBsMostProtocol.StreamType.stream<'a> = ""

/* Creates a Meta3dBsMostProtocol.StreamType.stream from an array */
@bs.module("most") external from: array<'a> => Meta3dBsMostProtocol.StreamType.stream<'a> = ""
...
@bs.module("most")
external fromPromise: Js.Promise.t<'a> => Meta3dBsMostProtocol.StreamType.stream<'a> = ""
...
@bs.module("most") external periodic: int => Meta3dBsMostProtocol.StreamType.stream<unit> = ""

/* Create a Meta3dBsMostProtocol.StreamType.stream that contains no events and never ends */
@bs.module("most") external never: unit => Meta3dBsMostProtocol.StreamType.stream<'a> = ""
...
@bs.module("most") external iterate: ('a => 'a, 'a) => Meta3dBsMostProtocol.StreamType.stream<'a> = ""

/* Same as `iterate`, but the function may return a promise.
 This allows one to build asynchronous streams of future values */
@bs.module("most")
external iteratePromise: ('a => Js.Promise.t<'a>, 'a) => Meta3dBsMostProtocol.StreamType.stream<'a> =
  "iterate"
...
external fromEvent: (
  ...
  Dom.eventTarget,
  bool,
) => Meta3dBsMostProtocol.StreamType.stream<Dom.event> = ""

/* Concatenates two streams together */
@bs.send.pipe(: Meta3dBsMostProtocol.StreamType.stream<'a>)
external concat: Meta3dBsMostProtocol.StreamType.stream<'a> => Meta3dBsMostProtocol.StreamType.stream<
  'a,
> = ""
...
@bs.module("most") external throwError: Js.Exn.t => Meta3dBsMostProtocol.StreamType.stream<unit> = ""
...
@bs.module("most")
external timestamp: Meta3dBsMostProtocol.StreamType.stream<'a> => Meta3dBsMostProtocol.StreamType.stream<{
  "time": int,
  "value": 'a,
}> = ""
...
external combine: (
  ...
  Meta3dBsMostProtocol.StreamType.stream<'a>,
  Meta3dBsMostProtocol.StreamType.stream<'b>,
) => Meta3dBsMostProtocol.StreamType.stream<'c> = ""
...
/* external combineArray : (array 'a => 'b) => array (Meta3dBsMostProtocol.StreamType.stream 'a) => Meta3dBsMostProtocol.StreamType.stream 'a = "" [@@bs.module "most"]; */
...
@bs.module("most")
external multicast: Meta3dBsMostProtocol.StreamType.stream<'a> => Meta3dBsMostProtocol.StreamType.stream<
  'a,
> = ""
