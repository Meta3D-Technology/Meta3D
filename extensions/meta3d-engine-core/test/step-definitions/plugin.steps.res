...
//       Main.runPipeline(Meta3dBsMost.Main.getService(), "init")->Meta3dBsMost.Most.drain->Obj.magic
//     })
...
//       Main.runPipeline("update")->Meta3dBsMost.Most.drain->Obj.magic
//     })
...
//     \"when"("run init pipeline", () => {
//       Main.runPipeline("init")->Meta3dBsMost.Most.drain->Obj.magic
//     })
