...
import * as OperateTree$Meta3dEngineCoreSceneview from "./OperateTree.bs.js";
...
function init(state, meta3dState) {
  ...
  return ListSt$Meta3dCommonlib.reduce(allRegisteredPipelineContribute, {
              ...
              usedGameObjectContribute: state.usedGameObjectContribute
                ...
                var match = param[0];
                StateContainer$Meta3dEngineCoreSceneview.setState(state);
                ...
                return StateContainer$Meta3dEngineCoreSceneview.unsafeGetState(undefined);
              }));
}
...
function _handleInsertedAsRootNode(treeDataList, param) {
  ...
  return ListSt$Meta3dCommonlib.reduce(treeDataList, [
              ...
              undefined
                ...
                var insertedTree = TreeNode$Meta3dEngineCoreSceneview.buildNode(pipelineName, [
                      getExecFunc,
                      pipelineData,
                      nodeJobOrderOpt
                    ], treeData[0]);
                ...
                if (exit === 1) {
                  var match$1 = ListSt$Meta3dCommonlib.reduce(sameLevelTreeList, [
                        ...
                        false
                          ...
                          var isInsertTo = param[1];
                          var match = OperateTree$Meta3dEngineCoreSceneview.insertNode(tree, nodeInsertPipelineName, node);
                          return [
  ...
  return ListSt$Meta3dCommonlib.filter(ListSt$Meta3dCommonlib.map(treeDataList, (function (param) {
                    return [
                            ListSt$Meta3dCommonlib.filter(param[0], (function (sameLevelTree) {
                                    return !TreeNode$Meta3dEngineCoreSceneview.isEqual(sameLevelTree, insertedTree);
                                  })),
                            param[1]
                          ];
                  })), (function (param) {
...
function _buildTree(allSpecificPipelineRelatedData) {
  return _getTree(ListSt$Meta3dCommonlib.reduce(allSpecificPipelineRelatedData, /* [] */0, (function (treeDataList, param) {
                    ...
                    if (jobOrder !== undefined) {
                      ...
                      var node = TreeNode$Meta3dEngineCoreSceneview.buildNode(pipelineName, [
                            getExecFunc,
                            pipelineData,
                            nodeJobOrderOpt
                          ], /* [] */0);
                    ...
                    if (OptionSt$Meta3dCommonlib.isSome(match$3[1])) {
                      ...
                      return _add(treeDataList$4, TreeNode$Meta3dEngineCoreSceneview.buildNode(pipelineName, [
                                      getExecFunc,
                                      pipelineData,
                                      undefined
                                    ], /* [] */0), undefined);
...
function _mergeToRootNode(tree) {
  return Result$Meta3dCommonlib.mapSuccess(IterateTree$Meta3dEngineCoreSceneview.postOrderCataWithParentNode((function (parentNodeOpt, pipelineName, nodeData) {
                    var getExecFuncs = nodeData.getExecFuncs;
                    var pipelineData = nodeData.pipelineData;
                    var jobOrder = nodeData.jobOrder;
                    return function (children) {
                      var node = TreeNode$Meta3dEngineCoreSceneview.buildNodeByNodeData(pipelineName, nodeData, children);
                      if (parentNodeOpt === undefined) {
                        return Result$Meta3dCommonlib.succeed(node);
                      }
                      var parentNodeData = TreeNode$Meta3dEngineCoreSceneview.getNodeData(parentNodeOpt);
                ...
                var match = TreeNode$Meta3dEngineCoreSceneview.getNodeData(tree);
