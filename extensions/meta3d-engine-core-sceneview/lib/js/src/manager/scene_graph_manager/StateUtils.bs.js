...
function getAllUsedContributes(state) {
  return [
          ...
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentTransformProtocol.componentName),
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentPbrmaterialProtocol.componentName),
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentGeometryProtocol.componentName),
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentDirectionlightProtocol.componentName),
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentArcballcameracontrollerProtocol.componentName),
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentBasiccameraviewProtocol.componentName),
          ComponentManager$Meta3dEngineCoreSceneview.unsafeGetUsedComponentContribute(state, Index$Meta3dComponentPerspectivecameraprojectionProtocol.componentName)
        ];
}
