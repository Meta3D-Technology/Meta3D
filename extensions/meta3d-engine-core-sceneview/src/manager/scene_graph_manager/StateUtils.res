let unsafeGetUsedGameObjectContribute = (
  {usedGameObjectContribute}: Meta3dEngineCoreSceneviewProtocol.StateType.state,
): Meta3dEngineCoreSceneviewProtocol.GameObjectType.usedGameObjectContribute => {
...
let setGameObjectStateToState = (
  ...
  usedGameObjectContribute: Meta3dEngineCoreSceneviewProtocol.GameObjectType.usedGameObjectContribute,
  gameObjectState: Meta3dEngineCoreSceneviewProtocol.GameObjectType.state,
