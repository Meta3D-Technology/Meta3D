...
Meta3d_jest.describe("CanvasAPI", (function (param) {
        ...
        return Meta3d_jest.describe("setCanvas", (function (param) {
                      return Meta3d_jest.test("set canvas", (function (param) {
                                    ...
                                    return Curry._2(Meta3d_jest.Expect.Operators.$eq, Meta3d_jest.Expect.expect(CanvasDoService$Meta3dEvent.getCanvas(ContainerManager$Meta3dEvent.getState(undefined))), 2);
                                  }));
                    }));
      }));
