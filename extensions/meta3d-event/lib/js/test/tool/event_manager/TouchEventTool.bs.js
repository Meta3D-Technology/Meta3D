...
function setLastXY(lastX, lastY) {
  return ContainerManager$Meta3dEvent.setState(HandleTouchEventDoService$Meta3dEvent.setLastXY(ContainerManager$Meta3dEvent.getState(undefined), lastX, lastY));
}

function getIsDrag(param) {
  return HandleTouchEventDoService$Meta3dEvent.getIsDrag(ContainerManager$Meta3dEvent.getState(undefined));
}

function setIsDrag(isDrag) {
  return ContainerManager$Meta3dEvent.setState(HandleTouchEventDoService$Meta3dEvent.setIsDrag(ContainerManager$Meta3dEvent.getState(undefined), isDrag));
}
