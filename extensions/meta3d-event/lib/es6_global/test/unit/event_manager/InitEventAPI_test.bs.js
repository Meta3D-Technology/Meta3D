...
import * as BodyAPI$Meta3dEvent from "../../tool/api/BodyAPI.bs.js";
import * as BodyTool$Meta3dEvent from "../../tool/event_manager/BodyTool.bs.js";
import * as TestTool$Meta3dEvent from "../../tool/event_manager/TestTool.bs.js";
import * as EventTool$Meta3dEvent from "../../tool/event_manager/EventTool.bs.js";
import * as ArraySt$Meta3dCommonlib from "../../../../../../../node_modules/meta3d-commonlib/lib/es6_global/src/structure/ArraySt.bs.js";
import * as InitEventAPI$Meta3dEvent from "../../tool/api/InitEventAPI.bs.js";
import * as OptionSt$Meta3dCommonlib from "../../../../../../../node_modules/meta3d-commonlib/lib/es6_global/src/structure/OptionSt.bs.js";
import * as ManageEventAPI$Meta3dEvent from "../../tool/api/ManageEventAPI.bs.js";
import * as MouseEventTool$Meta3dEvent from "../../tool/event_manager/MouseEventTool.bs.js";
import * as TouchEventTool$Meta3dEvent from "../../tool/event_manager/TouchEventTool.bs.js";
import * as CustomEventTool$Meta3dEvent from "../../tool/event_manager/CustomEventTool.bs.js";
import * as KeyboardEventTool$Meta3dEvent from "../../tool/event_manager/KeyboardEventTool.bs.js";
...
Meta3d_jest.describe("InitEventAPI", (function (param) {
        ...
        Meta3d_jest.describe("bind dom event", (function (param) {
                Meta3d_jest.describe("bind mouse event", (function (param) {
                        ...
                        Meta3d_jest.describe("bind mousedown event", (function (param) {
                                ...
                                Meta3d_jest.describe("test mouse event", (function (param) {
                                        Meta3d_jest.describe("test locationInView", (function (param) {
                                                ...
                                                Meta3d_jest.test("test view has offsetParent", (function (param) {
                                        ...
                                        Meta3d_jest.describe("test button", (function (param) {
                                                ...
                                                Meta3d_jest.test("test Right", (function (param) {
                                        ...
                                        Meta3d_jest.describe("test movementDelta", (function (param) {
                                                Meta3d_jest.describe("if is pointer locked", (function (param) {
                                                        Meta3d_jest.test("get data from event.movementX/movementY", (function (param) {
                                                                MouseEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                                ...
                                                Meta3d_jest.describe("else, compute", (function (param) {
                                                        ...
                                                        Meta3d_jest.test("test has lastX, lastY", (function (param) {
                                                                return _test([
                                                                            1,
                                                                            2
                                                                          ], [
                                        ...
                                        Meta3d_jest.describe("test wheel", (function (param) {
                                                ...
                                                Meta3d_jest.test("else, return 0", (function (param) {
                                        ...
                                        Meta3d_jest.describe("test other data", (function (param) {
                                                Meta3d_jest.test("test name, location", (function (param) {
                                                        MouseEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                                        var name = {
                                                          contents: /* MouseUp */3
                                                        };
                                ...
                                Meta3d_jest.describe("test priority", (function (param) {
                                        Meta3d_jest.test("the higher priority handleFunc is executed first", (function (param) {
                                                MouseEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                                var value = {
                                                  contents: 2
                                                };
                        ...
                        Meta3d_jest.describe("bind mouseup event", (function (param) {
                                _testMouseEvent(/* MouseUp */3, "mouseup");
                              }));
                        ...
                        Meta3d_jest.describe("bind mousemove event", (function (param) {
                                ...
                                Meta3d_jest.describe("test mouse event", (function (param) {
                                        Meta3d_jest.describe("test movementDelta", (function (param) {
                                                Meta3d_jest.test("set lastX, lastY after handle", (function (param) {
                                                        MouseEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                                        MouseEventTool$Meta3dEvent.setNotPointerLocked();
                        ...
                        Meta3d_jest.describe("bind mousedrag event", (function (param) {
                                ...
                                Meta3d_jest.describe("test movement", (function (param) {
                                        ...
                                        Meta3d_jest.test("reset lastX,lastY when drag start", (function (param) {
                                                var match = _prepare(undefined);
                                                EventTool$Meta3dEvent.triggerDomEvent("mousemove", EventTool$Meta3dEvent.getPointEventBindedDom(undefined), MouseEventTool$Meta3dEvent.buildMouseEvent(1, 2, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined));
                                                EventTool$Meta3dEvent.triggerDomEvent("mousedown", EventTool$Meta3dEvent.getPointEventBindedDom(undefined), MouseEventTool$Meta3dEvent.buildMouseEvent(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined));
                ...
                Meta3d_jest.describe("bind keyboard event", (function (param) {
                        ...
                        Meta3d_jest.describe("bind keyup event", (function (param) {
                                ...
                                Meta3d_jest.describe("test keyboard event", (function (param) {
                                        ...
                                        Meta3d_jest.describe("test key", (function (param) {
                                                ...
                                                Meta3d_jest.describe("else", (function (param) {
                                                        Meta3d_jest.test("if shiftKey=true, get key from shiftKeyByCharCodeMap", (function (param) {
                                                                KeyboardEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined);
                                                                var keyArr = [];
                                                                ManageEventAPI$Meta3dEvent.onKeyboardEvent(/* KeyUp */9, 0, (function ($$event, state) {
                        ...
                        Meta3d_jest.describe("bind keydown event", (function (param) {
                                _testKeyboardEvent(/* KeyDown */10, "keydown");
                              }));
                        Meta3d_jest.describe("bind keypress event", (function (param) {
                                _testKeyboardEvent(/* KeyPress */11, "keypress");
                              }));
                      }));
                Meta3d_jest.describe("bind touch event", (function (param) {
                        ...
                        Meta3d_jest.describe("bind touchstart event", (function (param) {
                                ...
                                Meta3d_jest.describe("test touch event", (function (param) {
                                        ...
                                        Meta3d_jest.describe("test movementDelta", (function (param) {
                                                Meta3d_jest.describe("compute by lastX,lastY", (function (param) {
                                                        var _test = function (param, param$1, param$2) {
                                                          TouchEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                        ...
                        Meta3d_jest.describe("bind touchend event", (function (param) {
                                _testTouchEvent(/* TouchEnd */13, "touchend");
                              }));
                        Meta3d_jest.describe("bind touchtap event", (function (param) {
                                Meta3d_jest.test("test trigger event after touchstart and touchend event", (function (param) {
                                        TouchEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                        var value = {
                                          contents: 0
                                        };
                        ...
                        Meta3d_jest.describe("bind touchdrag event", (function (param) {
        ...
        Meta3d_jest.describe("bind dom event to trigger point event", (function (param) {
                Meta3d_jest.describe("bind mouse event to trigger point event", (function (param) {
                        ...
                        Meta3d_jest.describe("test trigger pointdown event", (function (param) {
                                ...
                                Meta3d_jest.describe("test point event", (function (param) {
                                        ...
                                        Meta3d_jest.test("test name, location, locationInView, button, wheel, movementDelta", (function (param) {
                        ...
                        Meta3d_jest.describe("test trigger pointup event", (function (param) {
                                _testPointEvent(CustomEventTool$Meta3dEvent.getPointUpEventName(undefined), "mouseup");
                              }));
                        ...
                        Meta3d_jest.describe("test trigger pointdrag event", (function (param) {
                                ...
                                Meta3d_jest.test("test trigger pointdragdrop event when trigger mousedragdrop event", (function (param) {
                                        MouseEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                        var value = {
                                          contents: 0
                                        };
                ...
                Meta3d_jest.describe("bind touch event to trigger point event", (function (param) {
                        ...
                        Meta3d_jest.describe("test trigger pointup event", (function (param) {
                                _testPointEvent(CustomEventTool$Meta3dEvent.getPointUpEventName(undefined), "touchend");
                              }));
                        Meta3d_jest.describe("test trigger pointtap event", (function (param) {
                                Meta3d_jest.test("test bind", (function (param) {
                                        TouchEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                        ...
                        Meta3d_jest.describe("test trigger pointmove event", (function (param) {
                                _testPointEvent(CustomEventTool$Meta3dEvent.getPointMoveEventName(undefined), "touchmove");
                              }));
                        Meta3d_jest.describe("test trigger pointdrag event", (function (param) {
                                Meta3d_jest.test("test trigger event when trigger touchdrag event", (function (param) {
                                        TouchEventTool$Meta3dEvent.prepare(sandbox, undefined, undefined, undefined, undefined, undefined);
                                        var value = {
                                          contents: 0
                                        };
