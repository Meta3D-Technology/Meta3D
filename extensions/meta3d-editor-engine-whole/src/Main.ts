...
import { dependentExtensionNameMap, dependentContributeNameMap } from "meta3d-editor-engine-whole-protocol/src/service/DependentMapType"
...
> = (api, [{
	...
	meta3dEditorEngineRenderExtensionName,
}, {
}]) => {
		return {
			...
			prepare: (meta3dState: meta3dState, isDebug, ecsConfig, gl) => {
				...
				// let engineRenderState = api.getExtensionState<engineRenderState>(meta3dState, meta3dEditorEngineRenderExtensionName)
