...
import { dependentExtensionProtocolNameMap, dependentContributeProtocolNameMap } from "meta3d-extension-test2-protocol/src/service/DependentMapType"
...
export let getExtensionService: getExtensionServiceMeta3D<
	...
	service
> = (api, [{ meta3dTest1ExtensionProtocolName }, _]) => {
	return {
		invokeExtensionTest1: (meta3dState) => {
			...
			let extensionTest1State = api.getExtensionState<test1State>(meta3dState, meta3dTest1ExtensionProtocolName)
