...
meta3dState = registerExtension(meta3dState, appExtensionName, appExtensionFileData.extensionFuncData.getExtensionServiceFunc,
    appExtensionFileData.extensionFuncData.getExtensionLifeFunc,
    [
        {
            meta3dTest1ExtensionName: test1ExtensionName
        },
        null
    ], appExtensionFileData.extensionFuncData.createExtensionStateFunc())

meta3dState = registerExtension(meta3dState, test1ExtensionName, test1ExtensionFileData.extensionFuncData.getExtensionServiceFunc, test1ExtensionFileData.extensionFuncData.getExtensionLifeFunc, [
    null,
    {
        meta3dTest1ContributeName: test1ContributeName
    }
], test1ExtensionFileData.extensionFuncData.createExtensionStateFunc())
