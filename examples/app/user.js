...
let appExtensionFileData = loadExtension(generateExtension({
    "name": "meta3d-app",
    "protocol": {
...
let test1ExtensionFileData = loadExtension(generateExtension({
...
let test1ContributeFileData = loadContribute(generateContribute({
