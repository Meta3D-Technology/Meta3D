import { prepare as prepareMeta3D, registerExtension, registerContribute, getExtensionService } from "meta3d";
...
let { run } = getExtensionService(meta3dState, "meta3d-app");
