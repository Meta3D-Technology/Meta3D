...
let getData = (.
  ...
  switch dataName {
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.vertices =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.normals =>
    Meta3dComponentWorkerUtils.NormalsUtils.getNormals(normals, normalsInfos, isDebug, geometry)
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.texCoords =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.tangents =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.indices =>
  ...
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.vertices =>
    ...
    ->Obj.magic
    ->Js.Nullable.return
  | dataName if dataName == Meta3dComponentGeometryWorkerProtocol.Index.dataName.indicesCount =>
