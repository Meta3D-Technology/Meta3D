...
import { initGeometryUtils } from "../InitGeometryJobUtils"
...
export let execFunc: execFuncType = (engineCoreState, { getStatesFunc, setStatesFunc }) => {
	...
	return mostService.callFunc(() => {
		...
		let [newVerticesVBOMap, newIndicesVBOMap] = initGeometryUtils([webgl1Service, engineCoreService, immutableService],
			engineCoreState,
