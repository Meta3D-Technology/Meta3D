...
(0, jest_cucumber_1.defineFeature)(feature, test => {
    ...
    function _publishExtensionProtocol(packageFilePath = "", iconPath = "a.png") {
        return (0, Publish_1.publish)([readFileSyncFunc, logFunc, errorFunc, readJsonFunc, initFunc, hasDataFunc, getDataFunc, updateDataFunc], packageFilePath, iconPath, "extension");
    }
