...
export enum job {
    ConvertSceneGraph = "convert_scenegraph_three_sceneviewrender_meta3d",
    Init = "init_three_sceneviewrender_meta3d",
    Render = "render_three_sceneviewrender_meta3d",
    RestoreActivedCamera = "restore_actived_camera_three_sceneviewrender_meta3d",

    InitArcballCameraController = "init_arcballcameracontroller_three_sceneviewrender_meta3d",
    CreateDefaultScene = "create_default_scene_three_sceneviewrender_meta3d",
    UpdateCameraAspect = "update_camera_aspect_three_sceneviewrender_meta3d",
    UpdateArcballCameraController = "update_arcballcameracontroller_three_sceneviewrender_meta3d",
    ActiveArcball = "active_arcball_three_sceneviewrender_meta3d",
    BindEventOnce = "bind_event_once_three_sceneviewrender_meta3d",
    Reset = "reset_three_sceneviewrender_meta3d",
}
...
export const allPipelineData: allPipelineDataType = [
    {
        ...
        groups: [
            {
                name: "first_three_sceneviewrender_meta3d",
                link: "concat",
                elements: [
                    {
                        "name": job.Init,
        ...
        first_group: "first_three_sceneviewrender_meta3d"
    },
    {
