...
import { execFunc as execActiveArcball } from "./jobs/render/ActiveArcballJob";
import { execFunc as execRestoreActivedCamera } from "./jobs/render/RestoreActivedCameraJob";
...
let _getExecFunc = (_pipelineName: string, jobName: string) => {
	switch (jobName) {
		...
		case job.Reset:
			return execReset
		case job.ActiveArcball:
			return execActiveArcball
		case job.RestoreActivedCamera:
			return execRestoreActivedCamera
