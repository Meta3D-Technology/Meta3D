...
export let getTarget = (): target => {
    return (globalThis as any)["meta3d_arcball_event_target_sceneviewrender"]
}
...
export let getDragOverLocation = () => {
    return (globalThis as any)["dragOverLocation_sceneviewrender"]
}

let _setDragOverLocation = (dragOverLocation: nullable<[number, number]>) => {
    (globalThis as any)["dragOverLocation_sceneviewrender"] = dragOverLocation
}

export let getYaw = () => {
    return (globalThis as any)["yaw_sceneviewrender"]
}

let _setYaw = (yaw: nullable<number>) => {
    (globalThis as any)["yaw_sceneviewrender"] = yaw
}

export let getPitch = () => {
    return (globalThis as any)["pitch_sceneviewrender"]
}

let _setPitch = (pitch: nullable<number>) => {
    (globalThis as any)["pitch_sceneviewrender"] = pitch
}


export let getWheel = () => {
    return (globalThis as any)["wheel_sceneviewrender"]
}

let _setWheel = (wheel: number) => {
    (globalThis as any)["wheel_sceneviewrender"] = wheel
}
