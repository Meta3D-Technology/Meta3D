...
export type service = {
    ...
    readonly grid: (meta3dState: meta3dState, label: label, items: Array<{ texture: imguiImplTexture, name: string }>, columnCount: number, cellWidth: number, totalHeight: number) => [meta3dState, nullable<number>];
