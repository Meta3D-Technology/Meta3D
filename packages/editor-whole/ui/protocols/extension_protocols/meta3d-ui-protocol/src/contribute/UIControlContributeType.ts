...
// tslint:disable-next-line:interface-over-type-literal
export type uiControlFunc<inputFunc, specificData, outputData> = (_1: Meta3dType_Index_state, _2: inputFunc, _3: specificData) => Promise<[Meta3dType_Index_state, outputData]>;
