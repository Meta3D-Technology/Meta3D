...
let buildService = (
  ...
  ~inputInt1=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ...
  ~beginTabBar=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~endTabBar=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~beginTabItem=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~endTabItem=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ...
  ~sameLine=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~newLine=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~list=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~text=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~textColored=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~inputTextarea=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
  ~grid=createEmptyStub(refJsObjToSandbox(sandbox.contents)),
