...
> = api => {
  {
    ...
    inputInt1: UIManager.inputInt1((api, "meta3d-imgui-renderer-protocol")),
    ...
    beginTabBar: UIManager.beginTabBar((api, "meta3d-imgui-renderer-protocol")),
    endTabBar: UIManager.endTabBar((api, "meta3d-imgui-renderer-protocol")),
    beginTabItem: UIManager.beginTabItem((api, "meta3d-imgui-renderer-protocol")),
    endTabItem: UIManager.endTabItem((api, "meta3d-imgui-renderer-protocol")),
    ...
    newLine: UIManager.newLine((api, "meta3d-imgui-renderer-protocol")),
