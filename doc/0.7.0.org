...
**** TODO perf: shop not download; download when select(and show download progress)


**** TODO fix: Publish add key


**** TODO fix: catch/showCatch should log stack for console.error's stack

**** TODO perf: extension shop not show inner protocols:  meta3d-element-assemble-visual-protocol, meta3d-element-assemble-visual-run-protocol
