...
Custom:
Js Module(just as utils)
Action
Input



Action,Input can invoke Js Module's export functions
...
* TODO add Js Module(as utils)


TODO Action,Input can invoke Js Module's export functions

TODO publish Js Module

TODO can get Js Module from selected Published


TODO how to handle import utils(Js Module) in Input?
...
TODO move add/remove/editr custom to element assemble
