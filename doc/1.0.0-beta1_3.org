...
* TODO fix(platform): UIControlInspector: import app: Specific miss image


* TODO import action: not need empty before!

* TODO first enter ShowPublishedApps error


* TODO update ui control protocol->displayName

* TODO pass bdd test

* TODO update README -> snapshot
