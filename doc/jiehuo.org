...
* TODO fix: remove script from component not work

# * TODO fix: camera group can set arcball's data
...
* TODO fix: clone gameObject with script component error


# * TODO fix: add cube->add camera group->active, should be arcball!
