...
** TODO fix: input/action file str: switch select from custom to other, should reset file str
...
** TODO feat: auto generate version when publish app and element
...
** TODO feat: auto add version when publish extension,contribute, protocol
