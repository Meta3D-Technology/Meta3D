...
** TODO refactor: add work-plugins, components packages
...
** TODO finish sxengine's work without arcball, outline but include worker(should abstract sxengine code!!!)
