...
** TODO gameObject support dispose

** TODO pass bdd test


** TODO update engine-core extension
...
*** TODO update editor, add dispose gameObject button

gameObject should add transform component!
...
*** TODO add dispose, reallocate job
