...
* TODO add work-plugin-protocols

* TODO refactor: change protocol->name to "Meta3DXxx"

* TODO refactor: rename XxxMeta3d to XxxMeta3D




* TODO refactor: refactor component
...
** TODO  refactor Main.d.ts->export function getComponentContribute(): componentContribute<state, config, dataName, transform> to export let xxx
...
** TODO add all components(include worker)

need refactor, add dispose and clone!
...
** TODO sxengine add dispose job for no worker and worker
...
** TODO finish pbr material shader
