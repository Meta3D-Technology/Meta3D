...
*** TODO refactor: make elementFunc and elementState to be contribute like skin/custom control!!!
...
*** TODO refactor: make event to be contribute

*** TODO move to StateType?

# *** TODO rename EventType to IEvent?

*** TODO rename Ixxx(e.g. IWorker, IElement) to XxxContributeType
...
** TODO rename meta3d-extension-test1 to wonder-extension-test1
